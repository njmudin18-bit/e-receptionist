...
<div class="container">
    <a class="btn btn-success" href="javascript:void(0)" id="createNewStudent"> Create New Employee</a>
...
<script type="text/javascript">
    $(function() {
        ...
        $('body').on('click', '.editStudent', function() {
          ...
          var id = $(this).data('id');
          $.ajax({
            url: "{{ route('students.index') }}" + '/' + id + '/edit',
            type: "get",
            ...
            error: function(request, status, error) {
              let ErrorResponses  = JSON.parse(request.responseText);
              Swal.fire({
                title: error,
                text: ErrorResponses.message,
                icon: status
              });
            }
          });
