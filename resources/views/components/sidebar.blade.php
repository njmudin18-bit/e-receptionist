  ...
  <div class="leftside-menu">
    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
      ...
      <ul class="side-nav">
        ...
        @if(Auth::user()->can('pengunjung'))
        <li class="side-nav-item">
          <a href="{{ route('pengunjung.index') }}" class="side-nav-link">
        ...
        @if(Auth::user()->can('form'))
        <li class="side-nav-item">
          <a href="{{ route('form.index') }}" class="side-nav-link">
        ...
        @if(Auth::user()->can('form'))
        <li class="side-nav-item">
          <a href="{{ route('qr.index') }}" class="side-nav-link">
        ...
        @if(Auth::user()->can('telegram'))
        <li class="side-nav-item">
          <a href="{{ route('telegram.index') }}" class="side-nav-link">
            <i class="ri-telegram-line"></i>
            <span> Telegram Tokens </span>
          </a>
        </li>
        @endif
